...
<body <?php body_class(); ?>>
	<header>
		...
		<div class="wrap">
		<!-- <ul class="slick-box">
			<li><span><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/img_slide_01.jpg"</span></li>
			<li><span><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/img_slide_02.jpg"</span></li>
			<li><span><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/img_slide_03.jpg"</span></li>
		</ul> -->
		<ul class="slick-box">
